...
from source.CNN_Disease_Classifier.pipeline.stage_03_model_training import ModelTrainingPipeline
from source.CNN_Disease_Classifier.pipeline.stage_04_model_evaluation import EvaluationPipeline
